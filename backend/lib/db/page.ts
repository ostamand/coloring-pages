...
export async function addNewPage(
  ...
  const resultPage = await db.queryArray(
    `INSERT INTO pages (coloring_path, colored_path, generate_script, prompt, seed, collection_name, generated_on, name, model_name) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id;`,
    [
      coloringPath,
      coloredPath || null,
      generateScript,
